...
if __name__ == '__main__':
    ...
    app_mode = input("Choose the application mode, GUI or CLI. CLI by default (GUI is not avaliable right now): ").lower()
    ...
    if app_mode == 'cli':
        while True:
            ...
            if solve_another_yn == 'n':
                with open('assets/ascii_thanks.txt', encoding='utf-8') as thxf: print(thxf.read())
                break
